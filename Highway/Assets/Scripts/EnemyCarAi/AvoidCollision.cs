...
public class AvoidCollision : MonoBehaviour
{
    ...
    void Start()
    {
        double velocity = transform.parent.GetComponent<Rigidbody>().velocity.magnitude * 3.6f;
    ...
    void Update()
    {
        ...
        transform.parent.GetComponent<Rigidbody>().velocity = new Vector3(0, 0, mySpeed / 3.6f);
    }
    ...
    void OnTriggerStay(Collider collided)
    {
        ...
        {
            double newVelocity = collided.transform.parent.parent.GetComponent<Rigidbody>().velocity.magnitude * 3.6f;
